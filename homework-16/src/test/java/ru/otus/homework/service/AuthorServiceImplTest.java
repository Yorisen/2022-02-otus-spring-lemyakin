...
class AuthorServiceImplTest {
    ...
    private Optional<Author> authorOptional;
    ...
    void shouldGetAuthorById() {
        given(authorRepository.findById(author.getId())).willReturn(authorOptional);
        Optional<Author> actualAuthor = authorService.findById(author.getId());
        assertThat(actualAuthor).isEqualTo(authorOptional);
    }
    ...
    void shouldInsertAuthor() {
        ...
        given(authorRepository.save(newAuthor)).willReturn(author);
