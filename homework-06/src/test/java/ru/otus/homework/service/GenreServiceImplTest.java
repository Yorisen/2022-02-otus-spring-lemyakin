...
class GenreServiceImplTest {
    ...
    void shouldGetGenreById() {
        given(genreRepository.findById(genre.getId())).willReturn(genre);

        Genre actualGenre = genreService.getById(genre.getId());
    ...
    void shouldInsertGenre() {
        ...
        given(genreRepository.insert(newGenre)).willReturn(genre);
