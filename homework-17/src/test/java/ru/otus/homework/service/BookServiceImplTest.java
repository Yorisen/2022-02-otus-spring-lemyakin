...
class BookServiceImplTest {
    ...
    void shouldInsertBook() {
        ...
        given(authorRepository.findById(newBook.getAuthor().getId())).willReturn(Optional.ofNullable(book.getAuthor()));
        given(genreRepository.findById(newBook.getGenre().getId())).willReturn(genreOptional);
    ...
    void shouldUpdateBook() {
        ...
        given(authorRepository.findById(bookForUpdate.getAuthor().getId())).willReturn(Optional.ofNullable(book.getAuthor()));
        given(genreRepository.findById(bookForUpdate.getGenre().getId())).willReturn(genreOptional);
